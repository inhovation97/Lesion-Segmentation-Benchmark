...
from models.sotor_medical_seg_models.ESFPNet.Encoder  import mit
from models.sotor_medical_seg_models.ESFPNet.Decoder import mlp
from mmcv.cnn import ConvModule

class ESFPNetStructure(nn.Module):

    def __init__(self, embedding_dim = 160, model_type = 'B0'):
    ...
    def _init_weights(self, model_type = 'B0'):
        
        if model_type == 'B0':
            pretrained_dict = torch.load('./models/sotor_medical_seg_models/ESFPNet/Pretrained/mit_b0.pth')
